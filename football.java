...
public class football {
	...
	public static void main(String args[]) {
		...
		try {
			...
			benj_pavard.addProperty(RDFS.label, "défenseur");
			...
			didier_Deschamps.addProperty(age, m.createTypedLiteral("34", XSD.getURI() + "int"));
			equipeDeFrance.addProperty(entrainerPar,didier_Deschamps);
			
			Resource zlatko_Dalic = m.createResource(football + "Zlatko_Dalic");
			zlatko_Dalic.addProperty(RDF.type, entraineur);
			zlatko_Dalic.addProperty(RDFS.label, "Zlatko_Dalic");
			//zlatko_Dalic.addProperty(age, m.createTypedLiteral("54", XSD.getURI() + "int"));
			equipeDeCroatie.addProperty(entrainerPar,zlatko_Dalic);
