...
public class Construct_entraineur {
...
/* */
    public static void main(String[] args) {
        ...
        String rdq = prolog1
                ...
                + prolog3
                + NL
            + "CONSTRUCT WHERE { ?i rdf:type football:Entraineur ." +
                " ?i rdfs:label ?label ."+
                " ?i football:age ?age .}";
        //tout les individus attaquant dont l'age est renseigné
        ...
        try {
            FileOutputStream ost = new FileOutputStream("entraineurConstruct.n3");
            results.write(ost, "N3" ); 
        	System.out.println("pas de Zlatko_Dalic car pas d'âge renseigner");}
