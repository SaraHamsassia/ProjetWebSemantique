...
public class SPARQL_AgeFootballeur
{
	  ...
	  public static void main(String[] args)
	    {
		  ...
		  String fil_tom = "attaquantConstruct.n3";
		  ...
		  "SELECT ?s ?age WHERE { ?s football:age ?age . " 
		 +  " FILTER (?age > 30) }" ;
		  //renvoyer les attaquants de plus de 30 ans à partir du sous graph attaquantConstruct.n3
		  ...
		  try {
			  ...
			  System.out.println("les attaquant qui ont plus de 30 ans ");
			  System.out.println("-----------");
			  for (;results.hasNext();)
			  {
